...
$(function () {
   ...
   var $plus = $('.plus'),
    ...
    $('.delBtn').click(function () {
    	id =($(this).parents('.order_lists').data("id"))
	...
	$.ajax({
		...
		success:function(str){
			...
			var $res = arr.map(function(item){
				return `
				<ul class="order_lists" data-id="${item.id}">
						<li class="list_chk">
						...
						<li class="list_sum">
							<p class="sum_price">￥${item.price*item.number}</p>
						</li>
						<li class="list_op">
							<p class="del">
...
$('.amount_box').on('click','a',function(){
	num = $(this).parents('.amount_box').find('input').val()
	id = $(this).parents('.order_lists').data("id");
	isok = false;
	setTimeout(function() {
			$.ajax({
